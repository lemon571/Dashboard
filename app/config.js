...
require.config({
    ...
    paths: {
        ...
        "keyboard_event_listener": "./libs/kvm/keyboard_event_listener",
        "ivtp": "./libs/kvm/ivtp",
        ...
        "usbkeyboardjapanese": "./libs/kvm/usbkeyboardjapanese",
        ...
        "notification": "./libs/kvm/notify",
        "browser":"./libs/kvm/browser",
        "visibility":"./libs/kvm/visibility",
		...
		,
		"protocol-cdrom": "./libs/media/protocols/cdrom",
        "cdimage": "./libs/media/cdimage",
        "cdrom": "./libs/media/cdrom",
        "iusb-header": "./libs/media/iusb-header",
        "iusb-scsi-packet": "./libs/media/iusb-scsi-packet",
        "iusb-scsi": "./libs/media/iusb-scsi",
        "iusb-session": "./libs/media/iusb-session",
        "media-socket": "./libs/media/media-socket",
        "scsi-packet": "./libs/media/scsi-packet"
    },
	...
	,
	"video": ["datastream", "base64", "usbmessage", "utils", "event_listener","keyboard_event_listener", "ivtp", "mjbuilder",
            "softkeys", "touch_event_listener", "usbkeyboardenglish","usbkeyboardjapanese","usbkeyboardgerman",
            "usbkeyboardmessage", "usbmousemessage",
            "videosocket", "decode_worker", "usermacros", "oem_app", "notification", "browser", "hardwareCursor", "visibility" ],
    "datastream": ["encoding", "encoding-indexes"],
    "videoplayback": ["jquery", "datastream", "base64", "event_listener", "mjbuilder",
            "utils", "decode_worker"]
            
		,
		"cdrom": ["datastream", "base64", "protocol-cdrom", "cdimage", "iusb-header",
            "iusb-scsi", "iusb-scsi-packet", "iusb-session", "media-socket", "scsi-packet" ]
    },
	name: "main",
});
