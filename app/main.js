...
require(["config"], function() {
    require(["app", "router", "auto_router", 'i18next'], function(app, Router, AutoRouter, i18n) {
        ...
        {   
            storedLocale = navigator.userLanguage.toLowerCase();
        }   
        var temp = function(){
            console.log("Set language successfully");
            window.curLng = storedLocale;
        }
        
        var userLanguage = localStorage.select_lang;
        
        if (userLanguage != undefined) {
            document.cookie = "lang="+userLanguage;
            i18n.setLng(userLanguage, i18n.options, temp);
        }else{
            i18n.setLng(storedLocale, i18n.options, temp);
            document.cookie = "lang="+storedLocale;
